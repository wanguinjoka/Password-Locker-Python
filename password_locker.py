...
def main():
    print ('Welcome to Password Locker:-Where you can save your passwords.')
    while True:
        print(' ')
        print("_*_*_"*30)
        print ('To navigate through the site use this short cuts : \n nu-New user \n log-login \n ex-Exit')
        short_code = input('Enter short_code').lower().strip()
        if short_code == 'ex':
            break
            ...
            print(" ")
            print(f'New account created for:{ username } { password }')
        elif short_code == 'log':
            print("_*_*_"*30)
            print(' ')
